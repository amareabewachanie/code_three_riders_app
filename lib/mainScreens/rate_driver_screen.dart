          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(onPressed: (){
                DatabaseReference rateDriverReference=FirebaseDatabase.instance.ref().child("drivers")
                    .child(widget.assignedDriverId!).child("ratings");
                rateDriverReference.once().then((snapValue) {
                  // First trip of the driver
                    if(snapValue.snapshot.value ==null){
                      rateDriverReference.set(countRatingStars.toString());
                      SystemNavigator.pop();
                    }else{
                      double pastRatings=double.parse(snapValue.snapshot.value.toString());
